...
##We found out that the best accuracy is when we fill the missing values of age with the mean of the column (instead of omitting) and cross validation of 3.